  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto pt-30 pb-16 px-4">
        ...
        <div className="bg-orange-50 border-2 border-orange-500 p-6 rounded-xl shadow-md">
          <p className="text-gray-700 mb-4">
            Abonnement mensuel sans engagement – 9,99 € / mois
          </p>
          <ul className="space-y-3 mb-6 text-gray-800">
            ...
            <li className="flex items-center gap-2">
              <CheckCircle className="text-green-500" /> Résiliable à tout
              moment
            </li>
          </ul>
          <button
